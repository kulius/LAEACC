...
public partial class _Default : System.Web.UI.Page 
{
    ...
    protected void WebReport4_StartReport(object sender, EventArgs e)
    {
        WebReport4.Report = new FastReport.Labels();
        RegisterData(WebReport4.Report);
    }
    protected void WebReport2_StartReport(object sender, EventArgs e)
    {
        WebReport2.Report = new FastReport.Groups();
        RegisterData(WebReport2.Report);
    }
    protected void WebReport3_StartReport(object sender, EventArgs e)
    {
        WebReport3.Report = new FastReport.Barcodes();
        RegisterData(WebReport3.Report);
    }
