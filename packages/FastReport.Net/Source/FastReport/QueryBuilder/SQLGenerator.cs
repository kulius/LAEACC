...
namespace FastReport.FastQueryBuilder
{
    class SQLGenerator
    {
        ...
        {
            string result = QueryEnums.JoinTypesToStr[(int)lnk.Join] + " " + lnk.To.Table.getFromName(qch, !TableHasAlias.Contains(lnk.To.Table)) + " ON " + lnk.From.getFullName(qch, !TableHasAlias.Contains(lnk.From.Table)) + " = " + lnk.To.getFullName(qch, !TableHasAlias.Contains(lnk.To.Table)) + " \r\n";
