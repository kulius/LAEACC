...
namespace FastReport.Preview
{
  ...
  /// </remarks>
  [ToolboxItem(false)]
  public class PreparedPages : Component
  {
    #region Fields
    ...
    {
      FMacroValues["Page#"] = index + 1;
      FMacroValues["TotalPages#"] = FPreparedPages.Count;
      ReportPage page = FPreparedPages[index].GetPage(index);
