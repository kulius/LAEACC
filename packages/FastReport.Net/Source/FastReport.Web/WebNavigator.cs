    ...
    partial class WebReport
    {
        ...
        private void CreateNavigatorControls()
        {
            ...
            if (ShowToolbar)
            {
                ...
                //!!!
                //btnPrintBrowser.Width = 16;
                //btnPrintBrowser.Height = 16;
                //btnPrintBrowser.Text = "P";
                //btnPrintBrowser.Click += new EventHandler(btnPrintBrowser_Click);
                ...
                //cell = new HtmlTableCell();
                //cell.Width = "16";
                //cell.Controls.Add(btnPrintBrowser);
                //row.Cells.Add(cell);
        ...
        //void btnPrintBrowser_Click(object sender, EventArgs e)
        //{
        //    PrintBrowser();
        //}
