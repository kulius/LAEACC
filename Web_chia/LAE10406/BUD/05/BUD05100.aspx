<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BUD05100.aspx.vb" Inherits="LAEACC.BUD05100" %>
                                    ...
                                    <ContentTemplate>
                                        <div class="widget-body form-horizontal">
                                            <div style="background-color:#71eb8a; font-size:16px; padding-top:20px;">
                                                <asp:Button ID="btnCheck" Text="審查" CssClass="btn btn-primary" runat="server" />
                                                <fieldset>
                                                    <div class="form-group">
