<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BUD_ACCNAME.aspx.vb" Inherits="LAEACC.BUD_ACCNAME" %>
                                ...
                                <AjaxToolkit:TabPanel ID="TabPanel1" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <div class="table-responsive">
                                            ...
                                            <asp:DataGrid ID="DataGridView" Width = "100%" AllowSorting="false" AllowPaging="true" PageSize="50" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                    ...
                                    <ContentTemplate>                                        
                                        <table id="table-data" rules="all">
                                            ...
                                            <tr>
                                                <th>科目代號：</th>
                                                <td>
                                                    <asp:TextBox ID="vxtAccno" CssClass="form-control" runat="server" />
                                            ...
                                            <tr>
                                                <th>記帳科目：</th>
                                                <td>
                                                    <asp:TextBox ID="vxtBook" CssClass="form-control" runat="server" />
                                                    <AjaxToolkit:MaskedEditExtender ID="MaskedEditExtender3" runat="server"
                                                            TargetControlID="vxtBook"
                                                            MaskType="None" Mask="?-????-??-??-???????-?"
                                                            InputDirection="LeftToRight" />
                                                </td>
                                            </tr>                                            
