                            ...
                            <div class="widget-body form-horizontal" style="font-size:16px; margin:10px 0px 10px 0px;" >
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="nudYear" CssClass="form-control td-left" Width="80" TextMode="Number" runat="server" min="0" max="999" step="1"/>
                                        <asp:Button ID="BtnSearch" Text="查詢" CssClass="btn btn-primary td-left" runat="server" />
								    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">科目</label>	
                                        <asp:DropDownList ID="cboAccno" CssClass="form-control" Width="500" runat="server" />
                                    </div>                                                                       								    
						        </fieldset> 
                            </div>                                       
                            <!--詳細內容顯示區-->                           
