<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BGQ100_bak.aspx.vb" Inherits="LAEACC.BGQ100_bak" %>
                                ...
                                <AjaxToolkit:TabPanel ID="TabPanel1" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <div class="table-responsive">
                                            ...
                                            <asp:DataGrid ID="DataGrid1" Width = "100%" AllowSorting="True" AllowPaging="True" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                ...
                                <AjaxToolkit:TabPanel ID="TabPanel2" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <table id="table-data" rules="all">
                                            ...
                                            <tr>                                                
                                                <td align="center" colspan="8">
                                                    <asp:Button ID="btnPrint" Text="推算簿列印" CssClass="btn btn-primary" runat="server" />
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <asp:DataGrid ID="DataGrid2" Width="100%" AllowSorting="True" AllowPaging="True" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                                    <asp:TemplateColumn HeaderText="管理" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate>                                                                                                            
                                                    ...
                                                    <asp:TemplateColumn HeaderText="摘要" HeaderStyle-Width="220">
                                                        <itemtemplate><asp:Label ID="摘要" Text='<%# Container.DataItem("REMARK").ToString%>' runat="server" /></itemtemplate>                                                        
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="收支" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="主計審核" HeaderStyle-Width="80" ItemStyle-HorizontalAlign="Center">
                                ...
                                <AjaxToolkit:TabPanel ID="TabPanel4" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <table id="table-data" rules="all">
                                            <tr>
                                                <th>請購編號</th>
                                                <td colspan="3"><asp:TextBox ID="txtQbgno" CssClass="form-control" runat="server" /></td>
                                            </tr>
                                            <tr>                                                
                                                <th>推算者</th>
                                            ...
                                            <tr>
                                                <td align="center" colspan="4">
                                                    <asp:Button ID="btnQbgno" Text="確定" CssClass="btn btn-primary" runat="server" />
                                ...
                                <AjaxToolkit:TabPanel ID="TabPanel5" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <div class="table-responsive">
                                            ...
                                            <asp:DataGrid ID="DataGridQuery" Width="100%" AllowSorting="True" AllowPaging="True" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
