<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BUD04200.aspx.vb" Inherits="LAEACC.BUD04200" %>
                                    ...
                                    <ContentTemplate>
                                        <div class="widget-body form-horizontal">
                                            <div style="background-color:#71eb8a; font-size:16px; padding-top:20px;">
                                                <asp:Button ID="btnPayOrder" Text="開支或最後一次開支" CssClass="btn btn-primary" runat="server" />
                                                <asp:Button ID="btnPaySeq" Text="分次開支" CssClass="btn btn-primary" runat="server" />
                                                <asp:Button ID="btnPayEnd" Text="本筆不再開支" CssClass="btn btn-primary" runat="server" />
                                                <fieldset>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-2 control-label" style="margin-left:-50px;"><asp:Label ID="DATE3" ForeColor="Blue" Font-Size="12pt" Font-Bold="True" runat="server" /></div>
                                                        <label class="col-lg-2 control-label">推算編號</label>
                                                        <div class="col-lg-2 control-label" style="margin-left:-50px;"><asp:Label ID="BGNO030" ForeColor="Blue" Font-Size="12pt" Font-Bold="True" runat="server" /></div>                                                    
                                                        <label class="col-lg-2 control-label">推算金額</label>
                                                        <div class="col-lg-2"><asp:TextBox ID="USEAMT" CssClass="form-control" placeholder="推算金額" runat="server" /></div>
                                                    </div>  
                                                    <div class="form-group">
                                        ...
                                        <div style="font-size:14px;">
                                            ...
                                            <asp:DataGrid ID="DataGrid_Tab3" Width = "100%" 
                                                ...
                                                <columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="受款人" HeaderStyle-Width="100" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="金額" HeaderStyle-Width="100" ItemStyle-HorizontalAlign="Center">
