<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BUD_PSNAME.aspx.vb" Inherits="LAEACC.BUD_PSNAME" %>
                                    ...
                                    <ContentTemplate>
                                        <div class="table-responsive">
                                            ...
                                            <asp:DataGrid ID="DataGridView" Width="100%" AllowSorting="True" AllowPaging="True" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                                    <asp:TemplateColumn HeaderText="" HeaderStyle-Width="20px" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate>
                                                            <asp:CheckBox ID="chk_select" runat="server" />
                                                            <asp:Label ID="id" Text='<%# Container.DataItem("autono").ToString%>' Visible="false" runat="server" />
                                                        </itemtemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="管理" HeaderStyle-Width="20px" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate>                                                                                                            
