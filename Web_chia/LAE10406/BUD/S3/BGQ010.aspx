<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BGQ010.aspx.vb" Inherits="LAEACC.BGQ010" %>
                            ...
                            <div class="easyui-panel" style="width:100%;" title="查詢條件值" data-options="iconCls:'icon-search'">
                                <table id="table-serch" rules="all">
                                    <tr>
                                     ...
                                     <tr>
                                        <th>使用者：</th>
                                        <td><asp:DropDownList ID="cboUser" Width="200px" runat="server" /></td>
                                    </tr>
                                    <tr>
                                ...
                                <AjaxToolkit:TabPanel ID="TabPanel1" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <div style="font-size:14px; OVERFLOW:auto;height:450px;">
                                            ...
                                            <asp:DataGrid ID="DataGrid1" Width="2048px" AllowSorting="False" AllowPaging="False" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="餘額" HeaderStyle-Width="100" ItemStyle-HorizontalAlign="right">
                                                        <itemtemplate><asp:Label ID="餘額" Text='<%# FormatNumber(Container.DataItem("bgamt_balance").ToString, 2)%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>                                                   
                                                ...
                                                <columns>
                                                    <asp:TemplateColumn HeaderText="管理">
                                                        <itemtemplate>                                                                                                            
                                                            ...
                                                            <asp:Label ID="id1" Text='<%# Container.DataItem("BGNO").ToString%>' Visible="false" runat="server" />
                                                            <asp:Label ID="id2" Text='<%# Container.DataItem("REL").ToString%>' Visible="false" runat="server" />
                                                            <asp:UpdatePanel ID="DataGridView_UpdatePanel" runat="server">                                                                
                                                                <Triggers><asp:AsyncPostBackTrigger ControlID="Show" EventName="Click" /></Triggers>
                                                            </asp:UpdatePanel>
                                                        </itemtemplate>                                                        
                                                    ...
                                                    <asp:TemplateColumn HeaderText="結束否" SortExpression="bgf020.CLOSEMARK">
                                                        <itemtemplate><asp:Label ID="結束否" Text='<%# Container.DataItem("CLOSEMARK").ToString%>' runat="server" /></itemtemplate>                                                    
                                        ...
                                        <table id="table-data" rules="all">
                                            ...
                                            <tr>                                                
                                                <td align="center" colspan="4">                                                    
                                                    <asp:Button ID="btnEmptyDate2" Text="取消主計審核" CssClass="btn btn-primary" Visible="false" runat="server" />
                                                    <asp:Button ID="btnEmptyDate3" Text="取消單位開支" CssClass="btn btn-primary" Visible="false" runat="server" />
                                                    <asp:Button ID="btnEmptyDate4" Text="取消主計開支" CssClass="btn btn-primary" Visible="false" runat="server" />
                                                    <asp:Button ID="btnEmptyDate" Text="快速取消開支" CssClass="btn btn-primary" Visible="false" runat="server" />
                                                    <asp:Button ID="btnBack" Text="回上頁" CssClass="btn btn-danger" runat="server" />
                                                </td>                                                
                                            </tr>
                                            <tr>
                                                <td align="center" colspan="4">
                                                    <asp:Button ID="btnModAccno" Text="修改科目" CssClass="btn btn-info" Visible="false" runat="server" /> 
                                                    <asp:Button ID="btnModOther" Text="修正摘要等" CssClass="btn btn-info" Visible="false" runat="server" />
                                                    <asp:Button ID="btnModAmt" Text="修改金額" CssClass="btn btn-info" Visible="false" runat="server" />
                                                    <asp:Button ID="btnDelete" Text="整筆刪除" CssClass="btn btn-danger" Visible="false" runat="server" />
                                                </td>
                                            </tr>
                                        </table>
                                        <asp:Panel  id="gbxModAccno" Visible="false" runat="server">
                                            請購科目
                                            <asp:DropDownList ID="txtAccno" runat="server" />
                                ...
                                <AjaxToolkit:TabPanel ID="TabPanel4" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <table id="table-data" rules="all">
                                            ...
                                            <tr>
                                                <td align="center" colspan="4">                                                    
                                                    <asp:Button ID="btnQEmptyDate" Text="快速取消開支" Visible="false" CssClass="btn btn-primary" runat="server" />
