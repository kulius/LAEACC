<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PAY090.aspx.vb" Inherits="LAEACC.PAY090" %>
            ...
            <table id="table-serch" rules="all">                                            
                <tr>
                    ...
                    <td style="text-align:center;">
                        <asp:TextBox ID="lblDate2" Width="80px" Enabled="false"  onClick="WdatePicker({dateFmt:'yyy-MM-dd',skin:'whyGreen'})" runat="server" />
                    </td>
                    <th>頁次：</th>
                    <td>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <asp:DataGrid ID="DataGridView" Width="100%" AllowSorting="false" AllowPaging="false" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="帳戶" HeaderStyle-Width="220" >
                                                    ...
                                                    <asp:TemplateColumn HeaderText="總帳收入" HeaderStyle-Width="75" ItemStyle-HorizontalAlign="left">
                                                        <itemtemplate><asp:Label ID="總帳收入" Text='<%# FormatNumber(Container.DataItem("RAMT").ToString, 0)%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="總帳支出" HeaderStyle-Width="75" ItemStyle-HorizontalAlign="left">
                                                        <itemtemplate><asp:Label ID="總帳支出" Text='<%# FormatNumber(Container.DataItem("PAMT").ToString, 0)%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                       
                                                    <asp:TemplateColumn HeaderText="列印否" HeaderStyle-Width="25" >
                                                        <itemtemplate><asp:Label ID="列印否" Text='<%# Container.DataItem("PRT_CODE").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="檢查結果" HeaderStyle-Width="75" >
                                                        <itemtemplate><asp:Label ID="檢查結果" Text='<%# Container.DataItem("ERRMARK").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
