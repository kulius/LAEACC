<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="SYSGROUP.aspx.vb" Inherits="LAEACC.SYSGROUP" %>
                                    ...
                                    <ContentTemplate>
                                        <table id="table-data" rules="all">
                                            <tr>
                                                <th>群組名稱：</th>
                                                <td>
                                                    <asp:TextBox ID="txtgroup_name" CssClass="form-control" Width="120" runat="server" />
