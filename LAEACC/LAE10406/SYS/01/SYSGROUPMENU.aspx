<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="SYSGROUPMENU.aspx.vb" Inherits="LAEACC.SYSGROUPMENU" %>
                                    ...
                                    <ContentTemplate>
                                        <table id="table-data" rules="all">
                                            <tr>
                                             ...
                                             <tr>
                                                <th class="auto-style1">所屬系統：</th>
                                                <td class="auto-style1">
                                                    <asp:DropDownList ID="cbos_system_id" CssClass="form-control td-left" Width="40%" AutoPostBack="True" runat="server" />  
