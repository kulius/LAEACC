<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="SYSUNIT.aspx.vb" Inherits="LAEACC.SYSUNIT" %>
                            ...
                            <div class="widget-body form-horizontal" style="font-size:16px; margin:10px 0px 10px 0px;" >
                                <fieldset>
                                    <div class="form-group">
                                        <asp:Button ID="BtnImport" Text="匯入Auth中單位" CssClass="btn btn-primary td-left" runat="server" />
								    </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <asp:DataGrid ID="DataGridView" Width="100%" AllowSorting="True" AllowPaging="True" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="單位代號" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="left">
                                                        <itemtemplate><asp:Label ID="單位代號" Text='<%# Container.DataItem("unit_id").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>                                                                            
                                                    <asp:TemplateColumn HeaderText="單位名稱" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ContentTemplate>
                                        <table id="table-data" rules="all">
                                            <tr>
                                                <th>單位代號：</th>
                                                <td>
                                                    <asp:TextBox ID="txtunit_id" CssClass="form-control" Width="120" runat="server" />
                                                    <asp:Label ID="lblkey" ForeColor="Blue" Font-Size="12pt" Font-Bold="True" Visible="False" runat="server" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>單位名稱：</th>
                                                <td><asp:TextBox ID="txtunit_name" CssClass="form-control" Width="200" runat="server" /></td>
                                            </tr>
