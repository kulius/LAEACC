...
#Region "@Page及控制功能操作@"
    Private Sub Page_Init(sender As Object, e As EventArgs) Handles Me.Init
        ...
        'RadioButtonList*****
        Master.Controller.objRadioButtonListOptionGG(PAYSTATE, "未定,1.預付款,5.暫收款,6.短期墊款,7.應付費用,8.沖銷,", ",1,5,6,7,8,", 0) '計劃類別

        Master.Controller.objDropDownListOptionDB(PAYBANK, DNS_ACC, "chf020", "bank", "bank+'-'+bankname", "", "bank asc", 0) '銀行

        UCBase1.Visible = False
        btnPayEnd.Visible = False
        btnPaySeq.Visible = False
        btnPayOrder.Text = "推算"
...
#Region "@共用底層副程式@"
    ...
    Public Sub FillData(ByVal strOrder As String, ByVal strSortType As String, Optional ByVal strSearch As String = "")
        ...
        strSSQL &= " WHERE a.CLOSEMARK <> 'Y' and a.date2 is not null"
        strSSQL &= strSearch
...
#Region "@資料查詢@"
    ...
    Sub BGF020_Load(ByVal strKey1 As String)
        ...
        If objDR99.Read Then
            ...
            USEAMT.Text = Trim(objDR99("USEAMT").ToString)
            PAYBANK.Text = Trim(objDR99("PAYBANK").ToString)
...
#End Region
    ...
    End Sub
    '分次開支
    Protected Sub btnPaySeq_Click(sender As Object, e As EventArgs) Handles btnPaySeq.Click

    End Sub
    '本筆不再開支
    Protected Sub btnPayEnd_Click(sender As Object, e As EventArgs) Handles btnPayEnd.Click
        Dim blnCheck As Boolean = False
