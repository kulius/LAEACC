<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ACF010.aspx.vb" Inherits="LAEACC.ACF010" %>
        ...
        <ContentTemplate>        
            ...
            <table id="table-serch" rules="all">                                            
                <tr>
                    ...
                    <td style="text-align:center;">
                       匯款單<asp:TextBox ID="txtQpayseq" Width="80"   runat="server"  /> 
                    </td>                                          
                    <td style="text-align:center;">
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        摘要
                        <asp:TextBox ID="txtQremark1" Width="120" runat="server"  />或
                        <asp:TextBox ID="txtQremark2" Width="120" runat="server"  />
                    </td>
                    <td style="text-align:center;">
                    ...
                    <td style="text-align:center;">
                       管理處<asp:TextBox ID="txtQarea" Width="80"  runat="server"  /> 
                    </td>                                        
                                        ...
                                        <div style="font-size:14px; OVERFLOW:auto;height:450px;">                                            
                                            ...
                                            <asp:DataGrid ID="DataGridView" Width="2048px" AllowSorting="true" AllowPaging="false" PageSize="100" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="年度" SortExpression="accyear" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="年度" Text='<%# Container.DataItem("accyear").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>                                                   
                                                    <asp:TemplateColumn HeaderText="類別" SortExpression="kind" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="類別" Text='<%# Container.DataItem("kind").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>                                                    
                                                    <asp:TemplateColumn HeaderText="製票號" SortExpression="no_1_no" HeaderStyle-Width="50" ItemStyle-HorizontalAlign="right">
                                                        <itemtemplate><asp:Label ID="製票號" Text='<%# Container.DataItem("no_1_no").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="傳票號" SortExpression="no_2_no" HeaderStyle-Width="50" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="傳票號" Text='<%# Container.DataItem("no_2_no").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="頁次" SortExpression="seq" HeaderStyle-Width="20" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="頁次" Text='<%# Container.DataItem("seq").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="項次" SortExpression="item" HeaderStyle-Width="20" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="借貸方" SortExpression="dc" HeaderStyle-Width="32" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="借貸方" Text='<%# Container.DataItem("dc").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="會計科目" SortExpression="accno" HeaderStyle-Width="160">
                                                        <itemtemplate><asp:Label ID="會計科目" Text='<%# Container.DataItem("accno").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="摘要" SortExpression="remark" HeaderStyle-Width="200">
                                                        <itemtemplate><asp:Label ID="摘要" Text='<%# Container.DataItem("remark").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="金額" SortExpression="amt" HeaderStyle-Width="110" ItemStyle-HorizontalAlign="right">
                                                        <itemtemplate><asp:Label ID="金額" Text='<%# FormatNumber(Container.DataItem("amt").ToString, 0)%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="實收付數" SortExpression="act_amt" HeaderStyle-Width="110" ItemStyle-HorizontalAlign="right">
                                                        <itemtemplate><asp:Label ID="實收付數" Text='<%# FormatNumber(Container.DataItem("act_amt").ToString, 0)%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="銀行" SortExpression="bank" HeaderStyle-Width="32" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="銀行" Text='<%# Container.DataItem("bank").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="支票號碼" SortExpression="chkno" HeaderStyle-Width="80" ItemStyle-HorizontalAlign="Center">
...
<%--                                                    <asp:TemplateColumn HeaderText="管理處" HeaderStyle-Width="75" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="過帳碼" SortExpression="books" HeaderStyle-Width="32" ItemStyle-HorizontalAlign="Center">
