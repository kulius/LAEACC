...
#Region "@共用底層副程式@"
    ...
    Public Sub FillData(ByVal strOrder As String, ByVal strSortType As String, Optional ByVal strSearch As String = "")
        ...
        ViewState("strD") = "QTYIN" & Format(Val(nudMM.Text), "00")
        ViewState("strC") = "QTYOUT" & Format(Val(nudMM.Text), "00")

        sqlstr = "SELECT a.*, a." & ViewState("strD") & " - a." & ViewState("strC") & " as netamt, b.accname  FROM  ACf100 a LEFT OUTER JOIN accname b" & _
    ...
    Public Function InsertData() As Boolean
        ...
        Master.ADO.GenInsSql("QTY_BEG", txtQty_Beg.Text, "N")
        Master.ADO.GenInsSql("kind", txtKind.Text, "U")
        Master.ADO.GenInsSql("UNIT", txtUnit.Text, "U")
        Master.ADO.GenInsSql("qtyin01", txtQtyin01.Text, "N")
        Master.ADO.GenInsSql("qtyin02", txtQtyin02.Text, "N")
        Master.ADO.GenInsSql("qtyin03", txtQtyin03.Text, "N")
        Master.ADO.GenInsSql("qtyin04", txtQtyin04.Text, "N")
        Master.ADO.GenInsSql("qtyin05", txtQtyin05.Text, "N")
        Master.ADO.GenInsSql("qtyin06", txtQtyin06.Text, "N")
        Master.ADO.GenInsSql("qtyin07", txtQtyin07.Text, "N")
        Master.ADO.GenInsSql("qtyin08", txtQtyin08.Text, "N")
        Master.ADO.GenInsSql("qtyin09", txtQtyin09.Text, "N")
        Master.ADO.GenInsSql("qtyin10", txtQtyin10.Text, "N")
        Master.ADO.GenInsSql("qtyin11", txtQtyin11.Text, "N")
        Master.ADO.GenInsSql("qtyin12", txtQtyin12.Text, "N")
        Master.ADO.GenInsSql("qtyout01", txtQtyout01.Text, "N")
        Master.ADO.GenInsSql("qtyout02", txtQtyout02.Text, "N")
        Master.ADO.GenInsSql("qtyout03", txtQtyout03.Text, "N")
        Master.ADO.GenInsSql("qtyout04", txtQtyout04.Text, "N")
        Master.ADO.GenInsSql("qtyout05", txtQtyout05.Text, "N")
        Master.ADO.GenInsSql("qtyout06", txtQtyout06.Text, "N")
        Master.ADO.GenInsSql("qtyout07", txtQtyout07.Text, "N")
        Master.ADO.GenInsSql("qtyout08", txtQtyout08.Text, "N")
        Master.ADO.GenInsSql("qtyout09", txtQtyout09.Text, "N")
        Master.ADO.GenInsSql("qtyout10", txtQtyout10.Text, "N")
        Master.ADO.GenInsSql("qtyout11", txtQtyout11.Text, "N")
        Master.ADO.GenInsSql("qtyout12", txtQtyout12.Text, "N")
    ...
    Public Function UpdateData() As Boolean
        ...
        Master.ADO.GenUpdsql("QTY_BEG", txtQty_Beg.Text, "N")
        Master.ADO.GenUpdsql("kind", txtKind.Text, "T")
        Master.ADO.GenUpdsql("UNIT", txtUnit.Text, "T")
        Master.ADO.GenUpdsql("qtyin01", txtQtyin01.Text, "N")
        Master.ADO.GenUpdsql("qtyin02", txtQtyin02.Text, "N")
        Master.ADO.GenUpdsql("qtyin03", txtQtyin03.Text, "N")
        Master.ADO.GenUpdsql("qtyin04", txtQtyin04.Text, "N")
        Master.ADO.GenUpdsql("qtyin05", txtQtyin05.Text, "N")
        Master.ADO.GenUpdsql("qtyin06", txtQtyin06.Text, "N")
        Master.ADO.GenUpdsql("qtyin07", txtQtyin07.Text, "N")
        Master.ADO.GenUpdsql("qtyin08", txtQtyin08.Text, "N")
        Master.ADO.GenUpdsql("qtyin09", txtQtyin09.Text, "N")
        Master.ADO.GenUpdsql("qtyin10", txtQtyin10.Text, "N")
        Master.ADO.GenUpdsql("qtyin11", txtQtyin11.Text, "N")
        Master.ADO.GenUpdsql("qtyin12", txtQtyin12.Text, "N")
        Master.ADO.GenUpdsql("qtyout01", txtQtyout01.Text, "N")
        Master.ADO.GenUpdsql("qtyout02", txtQtyout02.Text, "N")
        Master.ADO.GenUpdsql("qtyout03", txtQtyout03.Text, "N")
        Master.ADO.GenUpdsql("qtyout04", txtQtyout04.Text, "N")
        Master.ADO.GenUpdsql("qtyout05", txtQtyout05.Text, "N")
        Master.ADO.GenUpdsql("qtyout06", txtQtyout06.Text, "N")
        Master.ADO.GenUpdsql("qtyout07", txtQtyout07.Text, "N")
        Master.ADO.GenUpdsql("qtyout08", txtQtyout08.Text, "N")
        Master.ADO.GenUpdsql("qtyout09", txtQtyout09.Text, "N")
        Master.ADO.GenUpdsql("qtyout10", txtQtyout10.Text, "N")
        Master.ADO.GenUpdsql("qtyout11", txtQtyout11.Text, "N")
        Master.ADO.GenUpdsql("qtyout12", txtQtyout12.Text, "N")
...
#Region "@資料查詢@"
    ...
    Sub Data_Load(ByVal strKey1 As String)
        ...
        sqlstr = "SELECT a.*, a." & ViewState("strD") & " - a." & ViewState("strC") & " as netamt, b.accname  FROM  ACf100 a LEFT OUTER JOIN accname b" & _
         " ON a.accno = b.accno WHERE a.autono ='" & strKey1 & "'"
        ...
        If objDR99.Read Then
            ...
            txtQty_Beg.Text = Format(objDR99("qty_beg"), "###,###,###,###.######")
            txtKind.Text = objDR99("kind").ToString
            txtUnit.Text = objDR99("unit").ToString

            For intI = 1 To 12
                strI = Format(intI, "00")
                DirectCast(TabPanel2.FindControl("txtqtyin" & strI), TextBox).Text = Format(objDR99("qtyin" & strI), "###,###,###,###.######")
                DirectCast(TabPanel2.FindControl("txtqtyout" & strI), TextBox).Text = Format(objDR99("qtyout" & strI), "###,###,###,###.######")
                DirectCast(TabPanel2.FindControl("lblNet" & strI), Label).Text = Format(objDR99("qtyin" & strI) - objDR99("qtyout" & strI), "###,###,###,###.######")
            Next
...
#End Region
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        ...
        sqlstr += " a.kind as 規格,a.unit as 單位,a.qty_beg as 年初數量,"
        sqlstr += "a." & ViewState("strD") & " - a." & ViewState("strC") & " as 該月存量"
        sqlstr += " FROM  ACf100 a LEFT OUTER JOIN accname b"
