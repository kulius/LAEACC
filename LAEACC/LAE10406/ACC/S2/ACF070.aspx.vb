...
#Region "@共用底層副程式@"
    ...
    Public Sub FillData(ByVal strOrder As String, ByVal strSortType As String, Optional ByVal strSearch As String = "")
        ...
        sqlstr = "SELECT a.*,  b.accname  FROM  acf070 a LEFT OUTER JOIN accname b ON a.accno = b.accno" & _
                 " WHERE a.date_2 >='" & Master.Models.FullDate(dtpStartDate.Text) & "' and a.date_2 <='" & Master.Models.FullDate(dtpEndDate.Text) & _
                 "' and a.accno>='" & vxtStartNo.Text & "' and a.accno<='" & vxtEndNo.Text & "'"
    ...
    Public Function InsertData() As Boolean
        ...
        Master.ADO.GenInsSql("date_2", dtpDate.Text, "D")
        Master.ADO.GenInsSql("accno", vxtAccno.Text, "T")
        Master.ADO.GenInsSql("deamt1", txtDeAmt1.Text, "N")
        Master.ADO.GenInsSql("Deamt2", txtDeAmt2.Text, "N")
        Master.ADO.GenInsSql("Deamt3", txtDeAmt3.Text, "N")
        Master.ADO.GenInsSql("cramt1", txtCrAmt1.Text, "N")
        Master.ADO.GenInsSql("cramt2", txtCrAmt2.Text, "N")
        Master.ADO.GenInsSql("cramt3", txtCrAmt3.Text, "N")
    ...
    Public Function UpdateData() As Boolean
        ...
        Master.ADO.GenUpdsql("date_2", dtpDate.Text, "D")
        Master.ADO.GenUpdsql("accno", vxtAccno.Text, "T")
        Master.ADO.GenUpdsql("deamt1", txtDeAmt1.Text, "N")
        Master.ADO.GenUpdsql("Deamt2", txtDeAmt2.Text, "N")
        Master.ADO.GenUpdsql("Deamt3", txtDeAmt3.Text, "N")
        Master.ADO.GenUpdsql("cramt1", txtCrAmt1.Text, "N")
        Master.ADO.GenUpdsql("cramt2", txtCrAmt2.Text, "N")
        Master.ADO.GenUpdsql("cramt3", txtCrAmt3.Text, "N")
...
#Region "@資料查詢@"
    ...
    Sub Data_Load(ByVal strKey1 As String)
        ...
        If objDR99.Read Then
            ...
            dtpDate.Text = Master.Models.strDateADToChiness(Trim(objDR99("date_2").ToShortDateString.ToString))
            vxtAccno.Text = objDR99("accno").ToString
            lblAccname.Text = objDR99("accname").ToString
            txtDeAmt1.Text = FormatNumber(objDR99("deamt1"), 2)
            txtDeAmt2.Text = FormatNumber(objDR99("deamt2"), 2)
            txtDeAmt3.Text = FormatNumber(objDR99("deamt3"), 2)
            txtCrAmt1.Text = FormatNumber(objDR99("cramt1"), 2)
            txtCrAmt2.Text = FormatNumber(objDR99("cramt2"), 2)
            txtCrAmt3.Text = FormatNumber(objDR99("cramt3"), 2)
            lblSumDebit.Text = FormatNumber(objDR99("deamt1") + objDR99("deamt2") + objDR99("deamt3"), 2)
            lblSumCredit.Text = FormatNumber(objDR99("cramt1") + objDR99("cramt2") + objDR99("cramt3"), 2)
