<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ACF020.aspx.vb" Inherits="LAEACC.ACF020" %>
            ...
            <table id="table-serch" rules="all">                                            
                <tr>
                    <td style="text-align:center;">
                        年度<asp:TextBox ID="nudYear"  Width="50" TextMode="Number" runat="server" min="0"  step="1" />
                    </td>                                                                                                
                    <td style="text-align:center;">
                    ...
                    <td style="text-align:center;">
                       金額<asp:TextBox ID="txtQamt" Width="80"   runat="server"  /> 
                    </td>
                    
                    <td style="text-align:center;">
                        <span>起號</span>
                        <asp:TextBox ID="TxtStartNo"  Width="60" TextMode="Number" runat="server" min="0"  step="1" />
                        <span>迄號</span>
                        <asp:TextBox ID="TxtEndNo"  Width="60" TextMode="Number" runat="server" min="0"  step="1" />
                    </td>          
                    <td style="text-align:center;">
                       日期 <asp:TextBox ID="dtpDateB" Width="80px"  onClick="WdatePicker({dateFmt:'yyy-MM-dd',skin:'whyGreen'})" runat="server" />
                        ~<asp:TextBox ID="dtpDateE" Width="80px"  onClick="WdatePicker({dateFmt:'yyy-MM-dd',skin:'whyGreen'})" runat="server" />
                       
                    </td>                                       
                    <td style="text-align:center;">
                        <asp:Button ID="btnSearch" Text="搜尋" runat="server" />
                ...
                <tr>
                    <td style="text-align:center;">
                        代號<asp:TextBox ID="txtQaccno" Width="120"   runat="server"  />
                        <AjaxToolkit:MaskedEditExtender ID="MaskedEditExtender5" runat="server"
                            TargetControlID="txtQaccno"
                            Mask="N\-NNNN\-NN\-NN\-NNNNNNN\-N"
                            AutoCompleteValue=" " ClearTextOnInvalid="True"
                            Filtered=" " BehaviorID="_content_MaskedEditExtender5" Century="2000" />
                    </td>
                    <td style="text-align:center;">
                        <asp:RadioButton id="rdbKind1" Text="收入" GroupName="rdbKind" runat="server"/><asp:RadioButton id="rdbKind2" Text="支出" Checked="true" GroupName="rdbKind" runat="server"/><asp:RadioButton id="rdbKind3" Text="轉帳" GroupName="rdbKind" runat="server"/><asp:RadioButton id="rdbkind4" Text="全部" GroupName="rdbKind" runat="server"/>
                    </td>                                                                                                
                    <td style="text-align:center;">                        
                        摘要
                        <asp:TextBox ID="txtQremark1" Width="80" runat="server"  />或
                        <asp:TextBox ID="txtQremark2" Width="80" runat="server"  />
                    </td>
                    
                    <td style="text-align:center;" colspan="3">
                       排序條件：<asp:RadioButton id="rdbSortNo" Text="傳票號"  Checked="true" GroupName="rdbsort" runat="server"/><asp:RadioButton id="rdbSortDate" Text="日期+傳票號" GroupName="rdbsort" runat="server"/><asp:RadioButton id="rdbSortAccno" Text="科目+日期+傳票號" GroupName="rdbsort" runat="server"/>
                    </td>                                              
                                        ...
                                        <div style="font-size:14px; OVERFLOW:auto; height:450px;">                                            
                                            ...
                                            <asp:DataGrid ID="DataGridView" Width="2048px" AllowSorting="true" AllowPaging="false" PageSize="100" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="年度" SortExpression="a.accyear" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="年度" Text='<%# Container.DataItem("accyear").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>                                                   
                                                    <asp:TemplateColumn HeaderText="類別" SortExpression="a.kind" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="類別" Text='<%# Container.DataItem("kind").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>                                                    
                                                    <asp:TemplateColumn HeaderText="製票號" SortExpression="a.no_1_no" HeaderStyle-Width="50" ItemStyle-HorizontalAlign="right">
                                                        <itemtemplate><asp:Label ID="製票號" Text='<%# Container.DataItem("no_1_no").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="傳票號" SortExpression="a.no_2_no" HeaderStyle-Width="50" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="傳票號" Text='<%# Container.DataItem("no_2_no").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="頁次" SortExpression="a.seq" HeaderStyle-Width="20" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="頁次" Text='<%# Container.DataItem("seq").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="項次" SortExpression="a.item" HeaderStyle-Width="20" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="項次" Text='<%# Container.DataItem("item").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="製票日期" SortExpression="b.date_1" HeaderStyle-Width="60" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="收付日期" SortExpression="b.date_2" HeaderStyle-Width="60" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="借貸方" SortExpression="a.dc" HeaderStyle-Width="32" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="借貸方" Text='<%# Container.DataItem("dc").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="會計科目" SortExpression="a.accno" HeaderStyle-Width="160">
                                                        <itemtemplate><asp:Label ID="會計科目" Text='<%# Container.DataItem("accno").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="摘要" SortExpression="a.remark" HeaderStyle-Width="200">
                                                        <itemtemplate><asp:Label ID="摘要" Text='<%# Container.DataItem("remark").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="金額" SortExpression="a.amt" HeaderStyle-Width="110" ItemStyle-HorizontalAlign="right">
                                                        <itemtemplate><asp:Label ID="金額" Text='<%# FormatNumber(Container.DataItem("amt").ToString, 0)%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    
                                                    <asp:TemplateColumn HeaderText="內容別" SortExpression="a.COTN_CODE" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="內容別" Text='<%# Container.DataItem("COTN_CODE").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="銀行" SortExpression="b.bank" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="銀行" Text='<%# Container.DataItem("bank").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="材料數量" SortExpression="a.MAT_QTY" HeaderStyle-Width="40" ItemStyle-HorizontalAlign="right">
                                                        <itemtemplate><asp:Label ID="材料數量" Text= '<%# FormatNumber(Container.DataItem("MAT_QTY").ToString, 0)%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="材料單價" SortExpression="a.MAT_PRIC" HeaderStyle-Width="32" ItemStyle-HorizontalAlign="right">
                                                        <itemtemplate><asp:Label ID="材料單價" Text='<%# Container.DataItem("MAT_PRIC").ToString%>'  runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="相關科目" SortExpression="a.OTHER_ACCNO" HeaderStyle-Width="40">
                                                        <itemtemplate><asp:Label ID="相關科目" Text='<%# Container.DataItem("OTHER_ACCNO").ToString%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>                                                                                                                                                                 
                                                </columns>
                                            </asp:DataGrid>
                                        </div>
                                        ...
                                        <table id="table-data" rules="all">
                                            ...
                                            <tr>
                                                ...
                                                <AjaxToolkit:MaskedEditExtender ID="vxtAccno1_Mask" runat="server"
                                                            ...
                                                            Mask="N-NNNN-NN-NN-NNNNNNN-N" AutoCompleteValue=" " ClearTextOnInvalid="True"
                                            ...
                                            <tr>
                                                <th>內容別：</th>
                                                <td><asp:TextBox ID="txtCotn_code" CssClass="form-control" runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <th>材料數量：</th>
                                                <td><asp:TextBox ID="txtMat_qty" CssClass="form-control" runat="server" /></td>
                                                
                                            </tr>
                                            <tr>
                                                <th>材料單價：</th>
                                                <td><asp:TextBox ID="txtMat_pric" CssClass="form-control" runat="server" /></td>
                                                
                                            </tr>
                                            <tr>
                                                <th>相關科目：</th>
                                                <td><asp:TextBox ID="vxtOtheraccno"  Width="200px" runat="server" /><asp:Button ID="btnOtheraccno" Text="名稱" runat="server" /><asp:Label ID="lblOtheraccname"  ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></td>
                                                <AjaxToolkit:MaskedEditExtender ID="MaskedEditExtender3" runat="server"
                                                            TargetControlID="vxtOtheraccno"
                                                            Mask="N-NNNN-NN-NN-NNNNNNN-N" AutoCompleteValue=" " ClearTextOnInvalid="True"
                                                            Filtered=" " BehaviorID="_content_vxtAccno1_Mask" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" />
                                            </tr>
