...
Public Class FRPrintExcel
    ...
    Protected Sub Page_PreRenderComplete(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRenderComplete
        ...
        Dim ReportParam As Dictionary(Of String, String) = DirectCast(Session("ReportParam"), Dictionary(Of String, String))
        ...
        Dim xlsExport As New FastReport.Export.ExportBase
        ...
        '直接開啓的寫法
        Response.AddHeader("Content-Disposition", "inline; filename=some_filename.xls")
