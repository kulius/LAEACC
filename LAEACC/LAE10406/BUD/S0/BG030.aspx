<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BG030.aspx.vb" Inherits="LAEACC.BG030" %>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <asp:DataGrid ID="DataGridView" Width = "100%" AllowSorting="True" AllowPaging="True" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="發包" HeaderStyle-Width="100" ItemStyle-HorizontalAlign="Right" SortExpression="a.AMT2">
                                                        <itemtemplate><asp:Label ID="發包" Text='<%# FormatNumber(Container.DataItem("AMT2").ToString, 0)%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn> 
                                                    <asp:TemplateColumn HeaderText="變更" HeaderStyle-Width="100" ItemStyle-HorizontalAlign="Right" SortExpression="a.AMT3">
                                                        <itemtemplate><asp:Label ID="變更" Text='<%# FormatNumber(Container.DataItem("AMT3").ToString, 0)%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>                                                          
                                                </columns>
                                            </asp:DataGrid>
                                        </div>
                                    ...
                                    <ContentTemplate>
                                        <table id="table-data" rules="all">
                                            ...
                                            <tr>
                                                <th>請購編號：</th>
                                                <td>
                                                    <asp:Label ID="lblBgno" ForeColor="Blue" Font-Size="12pt" Font-Bold="True" Text="　　　　　" runat="server" />
                                            ...
                                            <tr>
                                                <th>單位請購日期：</th>
                                                <td colspan="5"><asp:Label ID="lblDate1" Font-Size="12pt" Font-Bold="True" runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <th>請購事由：</th>
                                                <td colspan="5"><asp:TextBox ID="txtRemark" Font-Size="12pt" Font-Bold="True" Width="100%" runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <th>請購金額：</th>
                                                <td><asp:Label ID="lblAmt1" ForeColor="Blue" Font-Size="12pt" Font-Bold="True" runat="server" /></td>
                                                <th>可支用：</th>
                                                <td colspan="3"><asp:Label ID="lblUseableAmt" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <th>發包金額：</th>
                                                <td><asp:TextBox ID="txtAmt2" CssClass="form-control" Font-Size="12pt" Font-Bold="True" runat="server" /></td>
                                                <th>原發包：</th>
                                                <td colspan="3"><asp:Label ID="lblAmt2" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <th>變更金額：</th>
                                                <td><asp:TextBox ID="txtAmt3" CssClass="form-control" Font-Size="12pt" Font-Bold="True"  runat="server" /></td>
                                                <th>原變更：</th>
                                                <td colspan="3"><asp:Label ID="lblAmt3" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <th>本筆已開支額=</th>
                                                <td style="width:20%;"><asp:Label ID="lblUseAmt" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></td>
                                                <th>預算科目餘額=</th>
                                                <td style="width:20%;"><asp:Label ID="lblBgamt" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></td>
                                                <th>科目開支餘額=</th>
                                                <td style="width:20%;"><asp:Label ID="lblUnUseamt" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></td>
                                            </tr>
                                            <tr>
