...
#Region "@共用底層副程式@"
    ...
    Public Function InsertData() As Boolean
        ...
        Master.ADO.GenInsSql("userid", txtuserid.Text, "T")
        Master.ADO.GenInsSql("userpwd", " ", "T")
        Master.ADO.GenInsSql("username", txtusername.Text, "U")
        Master.ADO.GenInsSql("userunit", txtuserunit.Text, "T")
        sqlstr = "insert into usertable " & Master.ADO.GenInsFunc
    ...
    Public Function UpdateData() As Boolean
        ...
        Master.ADO.GenUpdsql("userid", txtuserid.Text, "T")

        Master.ADO.GenUpdsql("username", txtusername.Text, "U")
        Master.ADO.GenUpdsql("userunit", txtuserunit.Text, "T")
        sqlstr = "update usertable set " & Master.ADO.genupdfunc & " where autono=" & KeyValue
...
#Region "@資料查詢@"
    ...
    Sub Data_Load(ByVal strKey1 As String)
        ...
        If objDR99.Read Then
            ...
            txtuserid.Text = Trim(objDR99("userid").ToString)
            txtusername.Text = Trim(objDR99("username").ToString)
            txtuserunit.Text = Trim(objDR99("userunit").ToString)
