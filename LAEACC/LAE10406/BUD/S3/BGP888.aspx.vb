...
#Region "@Page及控制功能操作@"
    Private Sub Page_Init(sender As Object, e As EventArgs) Handles Me.Init
        ...
        trigger.ControlID = BtnExcel.ID.ToString()
        UpdatePanel1.Triggers.Add(trigger)
...
#End Region
    ...
    Protected Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        ...
        Param.Add("UserUnit", Session("UserUnit").ToString.Substring(0, 3))  '使用者單位代號
        ...
        Param.Add("sYear", Session("sYear"))    '登入年度


        Master.PrintFR("BGP888年度預算保留申請統計表", Session("ORG"), DNS_ACC, Param)
    End Sub
    ...
    Protected Sub BtnExcel_Click(sender As Object, e As EventArgs) Handles BtnExcel.Click
        ...
        Master.PrintFRExcel("BGP888年度預算保留申請統計表", Session("ORG"), DNS_ACC, Param)
    End Sub
End Class