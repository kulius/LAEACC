<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BGP060.aspx.vb" Inherits="LAEACC.BGP060" %>
                    ...
                    <div class="row">
                        <article class="col-sm-12 col-md-12 col-lg-12">
                            <table id="table-data" rules="all">                                
                                ...
                                <tr>   
                                    <th>預算迄月：</th>                                             
                                    <td><asp:TextBox ID="nudMon" Width="80" TextMode="Number" runat="server" min="1" max="12" step="1"/></td>
                                </tr>                                                                          
                                <tr>                                                
