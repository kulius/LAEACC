...
#Region "@DataGrid_Tab@"
    ...
    Protected Sub btnInsert_Click(sender As Object, e As System.EventArgs) Handles btnInsert.Click
        'land0436[租約實物市價記錄表]*****        
        'strIRow = "id,years,update_id,update_date"
        'strIValue = "NEWID(),'" & intYears & "','" & Session("USERID") & "','" & SystemValue.NowDate & "'"

        'ADOODBC.dbInsert(DNS_LAELD, "land0436", strIRow, strIValue) '開啟儲存
    ...
    Sub strChangeDataBase(ByVal strSSQL As String)
        ...
        DataGridView.DataSource = objCmd99.ExecuteReader
...
#Region "@共用底層副程式@"
    ...
    Public Function InsertData() As Boolean
        ...
        strIValue &= "'" & "Y" & "','" & UNIT.Text & "','" & PAYSTATE.SelectedValue & "','" & SUBJECT.Text & "','1',"
