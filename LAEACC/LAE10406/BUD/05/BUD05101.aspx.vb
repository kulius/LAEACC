...
#Region "@共用底層副程式@"
    ...
    Public Sub FillData(ByVal strOrder As String, ByVal strSortType As String, Optional ByVal strSearch As String = "")
        '開啟查詢
        strSSQL = "SELECT a.BGNO, a.REL, b.ACCYEAR, b.ACCNO, b.DATE1, a.DATE3, a.USEAMT, a.remark," & _
...
#End Region
    ...
    Protected Sub btnCheck_Click(sender As Object, e As EventArgs) Handles btnCheck.Click
        ...
        'UPDATE BG030
        strUValue = "DATE4 = '" & Date.Now.ToShortDateString & "'"
        strWValue = "BGNO = '" & txtKey1.Text & "'"

        blnCheck = Master.ADO.dbEdit(DNS_ACC, "BGF030", strUValue, strWValue) '開啟儲存

        If blnCheck = True Then
            ScriptManager.RegisterStartupScript(Page, GetType(Page), "訊息", "alert('【審核完成】');", True)
            ViewState("MyStatus") = 0
            SetControls(0)
            FillData(ViewState("MyOrder"), ViewState("MySort"), ViewState("MySearch"))
            TabContainer1.ActiveTabIndex = 0
