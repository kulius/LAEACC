<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BUD05200.aspx.vb" Inherits="LAEACC.BUD05200" %>
                                    ...
                                    <ContentTemplate>
                                        <div class="widget-body form-horizontal">
                                            <div style="background-color:#71eb8a; font-size:16px; padding-top:20px;">
                                                <asp:Button ID="btnCheck" Text="審核" CssClass="btn btn-primary" runat="server" />
                                                <fieldset>
                                                    <div class="form-group">
