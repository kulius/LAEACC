<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BUD05102.aspx.vb" Inherits="LAEACC.BUD05102" %>
                        ...
                        <article class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <AjaxToolkit:TabContainer ID="TabContainer1" Width="100%" CssClass="Tab" runat="server" ActiveTabIndex="1">
                                ...
                                <AjaxToolkit:TabPanel ID="TabPanel2" runat="server">
                                    <HeaderTemplate>單位請購資料審查（B）</HeaderTemplate>
                                    <ContentTemplate>
                                        <div class="widget-body form-horizontal">
                                            <div style="background-color:#71eb8a; font-size:16px; padding-top:20px;">
                                                <asp:Button ID="btnCheck" Text="請購登記" CssClass="btn btn-primary" runat="server" />
                                                <asp:Button ID="btnCheck1" Text="直接開支" CssClass="btn btn-primary" runat="server" />
                                                <fieldset>
                                                    <div class="form-group">
