<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PAY025.aspx.vb" Inherits="LAEACC.PAY025" %>
                                    ...
                                    <ContentTemplate>
                                        <div class="widget-body form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6 control-label" ><asp:Label ID="lblRemark" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></div>  
                                            ...
                                            <asp:DataGrid ID="DataGridView" Width = "100%" runat="server" >
                                                <columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="製票號">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="實付數">
                                                        <itemtemplate><asp:Label ID="實付數" Text='<%# Container.DataItem("act_amt").ToString%>' runat="server" /></itemtemplate>                                                       
                                                        <HeaderStyle Width="120px" />
                                            ...
                                            <div class="widget-body form-horizontal">
                                                <div style="background-color:#71eb8a; font-size:16px; padding-top:20px;">
                                                    <fieldset>
                                                        <div class="form-group">
                                                            <label class="col-lg-1 control-label">帳戶餘額</label>  
                                                            <div class="col-lg-2 control-label" ><asp:Label ID="lblBalance" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></div>  
                                                            <label class="col-lg-1 control-label">支票總額</label>  
                                                            <div class="col-lg-2 control-label" ><asp:Label ID="lblTotAmt" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></div>
                                                            <label class="col-lg-1 control-label">傳票張數</label>  
                                                            <div class="col-lg-2 control-label" ><asp:Label ID="lblTotNo" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" /></div>  
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
                                            ...
                                            <div style="background-color:#71eb8a; font-size:16px; padding-top:20px;">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-2 control-label" ><asp:Label ID="lblTotamt2" ForeColor="Blue" Font-Size="12pt" Font-Bold="True"  runat="server" />	</div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-2"><asp:Button ID="btnAddPsname" Text="將受款人增入片語" CssClass="btn btn-primary" runat="server" /></div> 
                                                        <!--#伺服器驗證-->
                                                        <AjaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server"
                                                            TargetControlID="btnAddPsname" ConfirmText="您是否將受款人新增至片語檔??">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-2 control-label"><asp:Button ID="btnBack" Text="放棄" CssClass="btn btn-primary" runat="server" /></div>
