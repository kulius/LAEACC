...
#Region "@共用底層副程式@"
    ...
    Public Sub FillData(ByVal strOrder As String, ByVal strSortType As String, Optional ByVal strSearch As String = "")
        ...
        " date_2 >='" & Master.Models.FullDate(dtpStartDate.Text) & "' and date_2 <='" & Master.Models.FullDate(dtpEndDate.Text) & "'"
    ...
    Public Function InsertData() As Boolean
        ...
        Master.ADO.GenInsSql("date_2", Trim(dtpDate_2.Text), "D")
    ...
    Public Function UpdateData() As Boolean
        ...
        Master.ADO.GenUpdsql("date_2", Trim(dtpDate_2.Text), "D")
        ...
        sqlstr = "update CHF030 set " & Master.ADO.genupdfunc & " where autono=" & KeyValue
        retstr = Master.ADO.runsql(DNS_ACC, sqlstr)
        If retstr = "sqlok" Then
            MessageBx("修改成功")
            blnCheck = True
...
#Region "@資料查詢@"
    ...
    Sub Data_Load(ByVal strKey1 As String)
        ...
        If objDR99.Read Then
            ...
            dtpDate_2.Text = Master.Models.strDateADToChiness(Trim(objDR99("date_2").ToShortDateString.ToString))
