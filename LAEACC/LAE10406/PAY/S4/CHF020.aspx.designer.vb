...
Partial Public Class CHF020
    ...
    '''將移動欄位宣告從設計檔案修改為程式碼後置檔案。
    '''</remarks>
    Protected WithEvents txtDate_2 As Global.System.Web.UI.WebControls.TextBox
    ...
    '''將移動欄位宣告從設計檔案修改為程式碼後置檔案。
    '''</remarks>
    Protected WithEvents txtPrt_code As Global.System.Web.UI.WebControls.TextBox
    ...
    '''將移動欄位宣告從設計檔案修改為程式碼後置檔案。
    '''</remarks>
    Protected WithEvents txtChkForm As Global.System.Web.UI.WebControls.TextBox
