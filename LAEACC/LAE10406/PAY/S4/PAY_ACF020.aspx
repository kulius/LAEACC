<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PAY_ACF020.aspx.vb" Inherits="LAEACC.PAY_ACF020" %>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <asp:DataGrid ID="DataGridView" Width="100%" AllowSorting="false" AllowPaging="true" style="font-size:14px;" CssClass="table table-bordered table-condensed smart-form" runat="server" >
                                                <columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="會計科目" HeaderStyle-Width="160" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="內容別" HeaderStyle-Width="32" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <asp:TemplateColumn HeaderText="材料數量" HeaderStyle-Width="32" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="材料數量" Text= '<%# FormatNumber(Container.DataItem("MAT_QTY").ToString, 0)%>' runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="材料單價" HeaderStyle-Width="32" ItemStyle-HorizontalAlign="Center">
                                                        <itemtemplate><asp:Label ID="材料單價" Text='<%# Container.DataItem("MAT_PRIC").ToString%>'  runat="server" /></itemtemplate>                                                       
                                                    </asp:TemplateColumn>   
                                                    <asp:TemplateColumn HeaderText="相關科目" HeaderStyle-Width="32" ItemStyle-HorizontalAlign="Center">
