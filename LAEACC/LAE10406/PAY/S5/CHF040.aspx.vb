...
#Region "@共用底層副程式@"
    ...
    Public Function UpdateData() As Boolean
        ...
        Master.ADO.GenUpdsql("rdate", dtpRDate.Text, "D")
        Master.ADO.GenUpdsql("name", txtName.Text, "U")
        Master.ADO.GenUpdsql("because", txtBecause.Text, "U")
...
#Region "@資料查詢@"
    ...
    Sub Data_Load(ByVal strKey1 As String)
        ...
        If objDR99.Read Then
            ...
            dtpRDate.text = Master.Models.strDateADToChiness(Trim(objDR99("rdate").ToShortDateString.ToString))
            txtName.Text = Master.ADO.nz(objDR99("name"), "  ")
            txtAmt.Text = Format(Master.ADO.nz(objDR99("amt"), 0), "##0")
            txtBecause.Text = Master.ADO.nz(objDR99("because"), "")
