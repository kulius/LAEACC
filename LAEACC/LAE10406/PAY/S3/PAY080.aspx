<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PAY080.aspx.vb" Inherits="LAEACC.PAY080" %>
                    ...
                    <div class="row">
                        <article class="col-sm-12 col-md-12 col-lg-12">
                            <table id="table-data" rules="all">
                                ...
                                <tr> 
                                    <th>起印銀行：</th>                                             
                                    <td><asp:TextBox ID="txtSbank" Width="80px" runat="server" /></td>  
                                    <th>起印日期：</th>                                             
                                    <td>
                                ...
                                <tr> 
                                    <th>訖印銀行：</th>                                             
                                    <td><asp:TextBox ID="txtEbank" Width="80px" runat="server" /></td>  
                                    <th>訖印日期：</th>                                             
                                    <td>
