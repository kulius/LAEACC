...
#Region "@Page及控制功能操作@"
    Private Sub Page_Init(sender As Object, e As EventArgs) Handles Me.Init
        ...
        Else
            dtpDate.Text = Master.Models.strDateADToChiness(Trim(mydataset.Tables("chf020").Rows(0).Item("date_2").ToShortDateString.ToString))
        End If
        txtBank.Text = "01"
...
#End Region
    ...
    Protected Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        ...
        Param.Add("dtpDate", Master.Models.FullDate(dtpDate.Text))    '起始會計科目
        Param.Add("bank", txtBank.Text)    '結束會計科目
        ...
        Master.PrintFR("PAY120沖收付數", Session("ORG"), DNS_ACC, Param)
